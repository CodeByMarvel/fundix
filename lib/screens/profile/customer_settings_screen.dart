            ...
            _NavTile(
              ...
              onTap: () => _showOptionSheet(
                ...
                onSelected: (v) => setState(() {
                  _theme = v;
                  if (v == 'Dark') _darkMode = true;
                  if (v == 'Light') _darkMode = false;
                }),
              ),
            ),
            _divider(),
  ...
  Widget build(BuildContext context) => Column(
        ...
        children: [
          ...
          Padding(
            ...
            child: Align(alignment: Alignment.centerLeft, child: Text(title, style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w700, color: AppColors.textDark))),
          ),
          ...options.map((opt) {
            final isSelected = opt == selected;
            return ListTile(
              contentPadding: const EdgeInsets.symmetric(horizontal: 20),
              title: Text(opt, style: TextStyle(fontSize: 14, fontWeight: isSelected ? FontWeight.w600 : FontWeight.w400, color: isSelected ? AppColors.primary : AppColors.textDark)),
